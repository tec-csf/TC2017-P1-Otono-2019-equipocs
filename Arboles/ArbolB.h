...
public:
    ...
    void imprimirNodos();
    void imprimir(NodoB<T> & nodo);
    void inOrder();
    void reverseInOrder();
    void asc(NodoB<T> & nodo);
    void desc(NodoB<T> & nodo);
    
    void update(int num);
    int getRaiz();
    void setRaiz(int raizID);
    
    void borrarData(NodoB<T> & nodo,T data);
    void borrarHoja(NodoB<T> & nodo,int);
    void borrarNoHoja(NodoB<T> & padre,int);
    int getPredecesor(NodoB<T> & padre,int);
    int getNext(NodoB<T> & padre,int);
    void fill(NodoB<T> & padre,int);
    void borrowPredecesor(NodoB<T> & padre,int);
    void borrowNext(NodoB<T> & padre,int);
    void merge(NodoB<T> & padre,int);
    int buscarInfo(NodoB<T> & nodo,T);
